    ...
    <section class="container">
     <table class="table table-bordered table-striped table-hover js-exportable dataTable">
        ...
        while($rs = mysqli_fetch_array($qsql))
        {
          ...
          {
            echo "<td>&nbsp;
            <a href='treatment.php?editid=$rs[treatmentid]' class='btn btn-raised bg-green'>Modifier</a> 
            <a href='viewtreatment.php?delid=$rs[treatmentid]' class='btn btn-raised bg-blush'>Supprimer</a> </td>";
          }
          echo "</tr>";
        }
        ?>
