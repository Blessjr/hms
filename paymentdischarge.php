...
{
  $sql ="INSERT INTO payment(patientid,appointmentid,paiddate,paidtime,paidamount,status,cardnumber,cvvno,cardholder,expdate) values('$_GET[patientid]','$_GET[appointmentid]','$dt','$tim','$_POST[paidamount]','Actif','$_POST[cardnumber]','$_POST[pin]','$_POST[cardholder]','$_POST[expdate]')";
 ...
 $sql ="UPDATE billing SET discount=0.0, discountreason='aucun',discharge_time='$_POST[dischargetime]',discharge_date='$_POST[dischargedate]' WHERE appointmentid='$_GET[appointmentid]'";
  ...
  <div class="card" style="padding: 10px">
      ...
      <form method="post" action="">
        <table class="table table-bordered table-striped">
          ...
          <tbody>
          <tr>
              <td>Entrez le numéro de carte</td>
              <td><input class="form-control" type="text" name="cardnumber" id="cardnumber"></td>
            </tr>
            <tr>
            <td>Entrez le nom du titulaire</td>
              <td><input class="form-control" type="text" name="cardholder" id="cardholder"  ></td>
            </tr>
            <tr>
              <td>CVV</td>
            ...
            <tr>
            <td>Entrez la date d'expiration</td>
              <td><input class="form-control" type="text" name="expdate" min="<?php echo date("Y-m-d"); ?>" id="expdate" onfocus="(this.type='date')" ></td>
            </tr>
            <tr>
