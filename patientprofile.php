            ...
            <form method="post" action="" name="frmpatprfl" onSubmit="return validateform()">
                <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label for="">Numéro de mobile</label>
                                <div class="form-line">
...
var emailExp = /^[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-Z0-9]{2,4}$/; // Valider adresse e-mail
...
function validateform()
{
    ...
    else if(document.frmpatprfl.password && document.frmpatprfl.password.value == "")
    {
        alert("Le mot de passe ne doit pas être vide.");
        document.frmpatprfl.password.focus();
        return false;
    }
    else if(document.frmpatprfl.password && document.frmpatprfl.password.value.length < 8)
    {
        alert("Le mot de passe doit contenir plus de 8 caractères.");
        document.frmpatprfl.password.focus();
        return false;
    }
    else if(document.frmpatprfl.password && document.frmpatprfl.confirmpassword && document.frmpatprfl.password.value != document.frmpatprfl.confirmpassword.value )
    {
    ...
    else if(document.frmpatprfl.select && document.frmpatprfl.select.value == "")
    {
