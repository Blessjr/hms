...
if(isset($_POST['submit']))
{
	if(isset($_GET['editid']))
	{
		...
		{
			echo "<script>alert('Horaire du médecin mis à jour avec succès...');</script>";
		}
		else
		{
	...
	else
	{
		...
		if($qsql = mysqli_query($con,$sql))
		{
			echo "<script>alert('Horaire du médecin ajouté avec succès...');</script>";
		}
		else
		{
			echo mysqli_error($con);
...
<div class="container-fluid">
	<div class="block-header">
		<h2 class="text-center">Ajouter un nouvel horaire de médecin</h2>
	</div>
	<div class="card">
				...
				<tbody>
					...
					<tr>
						<td height="36" colspan="2" align="center">
							<input class="btn btn-default" type="submit" name="submit" id="submit" value="Valider" />
						</td>
					</tr>
				</tbody>
			</table>
