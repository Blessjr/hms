  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo" style="display: flex; align-items: center;">
        ...
        <img src="images/logo_main_white.jpeg?v=123" alt="Logo" style="height: 51px; margin-right: 10px;">
        <span style="color: white; font-size: 18px; font-weight: bold;">DOCTO LINK</span>
        </a>
      </div>
      <div class="head-info">
        <ul>
    ...
    <nav class="navbar ownmenu">
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-right" id="nav-open-btn">
          <ul class="nav">
            <li> <a href="index.php">Accuille </a></li>
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color:blue"> S'inscrire </a>
