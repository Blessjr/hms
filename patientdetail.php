...
if(isset($_POST['submitpat']))
{
	...
	{
		echo "<script>alert('Le dossier patient a été ajouté avec succès...');</script>";
	}
	else
	{
...
<form method="post" action="" name="frmpatdet" onSubmit="return validateform()">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="4" align="center"><input type="submit" name="submitpat" id="submitpat" value="Valider" /></td>
        </tr>
    </tbody>
    </table>       
</form>
