...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="INSERT INTO prescription(treatment_records_id,doctorid,patientid,prescriptiondate,status,appointmentid) values('$_POST[treatmentid]','$_POST[select2]','$_POST[patientid]','$_POST[date]','Actif','$_GET[appid]')";
		if($qsql = mysqli_query($con,$sql))
		{
...
<div class="container-fluid">
    ...
    <table class="table table-bordered table-striped">
      <tbody>
        <tr>
          ...
          <td>
            <?php
		  	$sqlpatient= "SELECT * FROM patient WHERE status='Actif' AND patientid='$_GET[patientid]'";
  ...
  <?php
        ...
        <tr>
          ...
          <td>
    		<?php
				$sqldoctor= "SELECT * FROM doctor INNER JOIN department ON department.departmentid=doctor.departmentid WHERE doctor.status='Actif' AND doctor.doctorid='$_SESSION[doctorid]'";
